...
export default class CreateForm extends Component {
  ...
  get isExternalIdTypeNotSelectedChecked() {
    return this.args.campaign.idPixType == null;
  }
  ...
  askLabelIdPix() {
    ...
    this.args.campaign.idPixType = 'STRING';
  }
  ...
  doNotAskLabelIdPix() {
    ...
    this.args.campaign.idPixType = null;
  }
  ...
  onChangeIdPixType(event) {
    ...
    console.log(this.args.campaign.idPixLabel, this.args.campaign.idPixType);
  }

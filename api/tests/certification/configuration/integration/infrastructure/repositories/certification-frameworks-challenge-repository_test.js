  ...
  describe('#find', function () {
    ...
    it('should return a consolidated framework sorted by challengeId', async function () {
      ...
      const expectedFrameworkChallenges = [
        domainBuilder.certification.configuration.buildCertificationFrameworksChallenge(firstChallengeSelected),
        domainBuilder.certification.configuration.buildCertificationFrameworksChallenge(secondChallengeSelected),
      ];
